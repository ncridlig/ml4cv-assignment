...
def save_best_model(model, miou, best_miou, base_name="models/checkpoints/deeplabv3_resnet50"):
    """
    ...
    if miou > best_miou:
        ...
        image_size = f"_size_{IMAGE_SIZE[0]}x{IMAGE_SIZE[1]}"
        path = f"{base_name}{timestamp}{performance}{image_size}.pth"
